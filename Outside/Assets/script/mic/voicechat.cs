...
namespace FrostweepGames.WebGLPUNVoice
{
    public class voicechat : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            recorder.reliableTransmission = true;
            recorder.debugEcho = true;
        ...
        private void SpeakersUpdatedEventHandler()
        {
            ...
            foreach (var speaker in listener.Speakers)
            {
                ...
                //_remoteSpeakerItems.Add(new RemoteSpeakerItem(remoteClientPrefab, speaker.Value));
            }
        }
        ...
        private class RemoteSpeakerItem
        {
            ...
            {
                //public RemoteSpeakerItem(GameObject prefab, Speaker speaker)
                //{
                Speaker = speaker;

                _selfObject = Instantiate(prefab, parent, false);
                //_selfObject = prefab;
                //_selfObject.transform.SetParent(Speaker.Parent);
